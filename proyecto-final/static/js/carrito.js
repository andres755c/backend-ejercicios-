...
const rutaFetch = 'http://localhost:4545/api/carritos/'
document.getElementById('delCarrito').addEventListener('click', borrarCart)
...
function renderizarEditarArchivos(domElement, id) {
    let targetEdit
    let targetOrigin
    let nodo
